...
export function serializeUser(
  ...
  return {
    ...
    mainHostUid: (raw.mainHostUid as string | null | undefined) ?? null,
    hostExpiresAt: tsToMsOrNull(raw.hostExpiresAt),
    subHostCap: Number(raw.subHostCap ?? 0),
    subHostUids: (raw.subHostUids as string[] | undefined) ?? [],
